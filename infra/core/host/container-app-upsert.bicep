...
module app 'container-app.bicep' = {
  ...
  params: {
    ...
    // BC: 2021-09-08: switched the above logic to check if container app exists and use the existing image name first
...
output managedSystemIdentity string = app.outputs.managedSystemIdentity
